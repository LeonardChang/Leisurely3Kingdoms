...
public class DataStringTable : EditorWindow
{
    ...
    [MenuItem("OORoom/字串表/普通字串")]
    static void Init()
    {
        EditorWindow.GetWindow(typeof(DataStringTable));
        mAsset = null;
    }
    ...
    void OnGUI()
    {
        ...
        if (!mAsset)
        {
            mAsset = (TextAsset)Resources.Load("Data/StringTable");
            ReadData();
        }
