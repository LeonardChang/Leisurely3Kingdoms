...
public class DataWinZombie : EditorWindow
{
    ...
    [MenuItem("OORoom/僵尸/僵尸数值")]
    static void Init()
    {
        EditorWindow.GetWindow(typeof(DataWinZombie));
        mAsset = null;
    }
    ...
    void OnGUI()
    {
        ...
        if (!mAsset)
        {
            mAsset = (TextAsset)Resources.Load("Data/ZombieData");
            ReadData();
        }
