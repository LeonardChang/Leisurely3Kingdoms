...
public class DataWinZombieDsc : EditorWindow
{
    ...
    [MenuItem("OORoom/僵尸/僵尸描述")]
    static void Init()
    {
        EditorWindow.GetWindow(typeof(DataWinZombieDsc));
        mAsset = null;
    }
    ...
    void OnGUI()
    {
        ...
        if (!mAsset)
        {
            mAsset = (TextAsset)Resources.Load("Data/ZombieDsc");
            ReadData();
        }
