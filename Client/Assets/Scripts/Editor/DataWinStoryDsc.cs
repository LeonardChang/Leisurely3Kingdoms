...
public class DataWinStoryDsc: EditorWindow
{
    ...
    [MenuItem("OORoom/剧情/剧情描述")]
    static void Init()
    {
        EditorWindow.GetWindow(typeof(DataWinStoryDsc));
        mAsset = null;
    }
    ...
    void OnGUI()
    {
        ...
        if (!mAsset)
        {
            mAsset = (TextAsset)Resources.Load("Data/Story/StoryInfo");
            ReadData();
        }
